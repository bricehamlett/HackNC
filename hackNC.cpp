...
void env1()
{
    ...
    if (items > 0)
    {
        cout << "You may also chose to use (i)" << inventory;
    }
...
void env3 ()
{
    ...
    {
        cout << "\nYou chose the sword. Good for you, because the gun had no bullets, and you win the fight." << endl;
...
void env6 ()
{
    ...
    {
        cout << "\nYou chose to code a text based game, and the code was perfect. You move to the next room!" << endl;
    }
    if (choice == 'V' || choice == 'v')
    {
        cout << "\nYou chose to code a VR game, and the code was horrendous. You die." << endl;
        alive = false;
    }
     else if (choice == 'I' || choice == 'i')
    {
